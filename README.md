...
## Contents
- [the-veil/](the-veil/README.md) — Top-level knowledge vault directory with manifesto, research, frameworks, community resources, and media assets.
...
If you want a different organization (expanded TOC, badges, contribution links, or a project description), open an issue or submit a pull request — see the Contributions section below.

## Quick links
- Manifesto: [the-veil/manifesto/manifesto.md](the-veil/manifesto/manifesto.md)
- Frameworks: [the-veil/frameworks/](the-veil/frameworks/)
- Research: [the-veil/research/](the-veil/research/)

## How to contribute
We welcome contributions of all kinds: research notes, frameworks, multimedia, community resources, and editorial improvements.

1. Read [STRUCTURE.md](STRUCTURE.md) to understand where to add content.
2. Check open issues and discussions to avoid duplicating work.
3. Fork the repository and open a PR with a clear description of your changes.
4. Use meaningful filenames and front-matter where applicable (see STRUCTURE.md for examples).
...
- Use Discussions for open-ended community conversations and brainstorming.
